 ...
 */
public class WeekendSlewRateLimiter {
     ...
     */
    public WeekendSlewRateLimiter(double positiveRateLimit, double negativeRateLimit, double initialValue) {
     ...
     */
    public WeekendSlewRateLimiter(double rateLimit) {
    ...
    public double calculate(double input) {
        ...
        SmartDashboard.putNumber("prev_val", m_prevVal);
